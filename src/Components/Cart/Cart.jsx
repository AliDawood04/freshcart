...
let {getCart ,cart,updateProductCount,loding,deleteProduct }=useContext(CartContext)
...
{loding?<Loding/>:<div>
  {cart?<div className="relative overflow-x-auto shadow-md sm:rounded-lg w-3/4 mx-auto">
  ...
  <Link to={"/checkout"} className='bg-mainColor text-center text-white p-2 m-2'>check out</Link>
</div>: "" }
